# ARIA - Workflow & Architecture Guide
...
**ARIA** is an AI-powered healthcare fraud detection system that uses multi-agent orchestration to investigate suspicious billing patterns, gather evidence, and compile comprehensive dossiers for potential prosecution.
